...
f = ModuleLoadTest("/usr/share/lmod/lmod/modulefiles/Core:/mxg-hpc/users/ssi29/spack/modules/linux-rhel7-x86_64/Core", purge=False)
...
j = ModuleLoadTest("/usr/share/lmod/lmod/modulefiles/Core",include=["settarg"], exclude=["lmod"])
